          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input
                type="url"
                value={config().logo}
                onInput={(e) => setConfig({ ...config(), logo: e.currentTarget.value })}
            ...
            <div>
              ...
              <input
                ...
                onInput={(e) => setConfig({ ...config(), footerText: e.currentTarget.value })}
                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          </div>
          ...
          <div class="space-y-4">
            <label class="flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e) =>
                  setConfig({ ...config(), enableComments: e.currentTarget.checked })
                }
            ...
            <label class="flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e) =>
                  setConfig({ ...config(), enableAnalytics: e.currentTarget.checked })
                }
                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
              />
            </label>
