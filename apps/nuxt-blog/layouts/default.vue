    ...
    <div class="max-w-4xl mx-auto">
      <header class="mb-8">
        <div class="flex items-center justify-between mb-4">
          <h1 class="text-4xl font-bold">Nuxt Blog</h1>
        ...
        <nav class="flex items-center gap-4 p-4 bg-gray-100 rounded-lg">
          <span class="font-semibold mr-2">{{ t("site.frameworkSwitch") }}</span>
          <a href="/next/" class="text-blue-600 hover:underline text-sm">{{ t("framework.next") }}</a>
          <a href="/nuxt/" class="text-green-600 hover:underline text-sm">{{ t("framework.nuxt") }}</a>
          <a href="/svelte/" class="text-orange-600 hover:underline text-sm">{{ t("framework.svelte") }}</a>
          <a href="/astro/" class="text-purple-600 hover:underline text-sm">{{ t("framework.astro") }}</a>
          <a href="/solid/" class="text-blue-500 hover:underline text-sm">{{ t("framework.solid") }}</a>
        </nav>
      </header>
